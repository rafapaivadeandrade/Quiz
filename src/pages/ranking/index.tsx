...
import { ContainerFormModal, FormBackground, ContainerRankingDiv, FormButton } from '../../components/FormBackground';
                    ...
                    <ContainerFormModal ranking={true} result={true}>
                        ...
                        {loading ? (
                            ...
                            <FormButton onClick={() => {
                                ...
                                router.push('/')
                            }}><button type='submit'><span style={{ fontSize: '44px' }} >{'INÍCIO'}</span></button></FormButton>
                        )}
                    </ContainerFormModal>
                </ContainerModal>
            </FormBackground>
